...
import 'package:flutter_flip_clock/util/system_util.dart';
...
class _FlipClockState extends State<FlipClockPage> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: SizedBox(
          height: (getScreenWidth(context) / 4.5 - 10) * 2 + 1,
          child: FlipClock(
            digitColor: Colors.grey[400],
            backgroundColor: Colors.grey[900],
            digitSize: getScreenWidth(context) / 3,
            borderRadius: const BorderRadius.all(Radius.circular(3.0)),
            width: getScreenWidth(context) / 4.5 - 10,
            height: (getScreenWidth(context) / 4.5 - 10) * 2,
